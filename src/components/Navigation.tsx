...
export default function Navigation() {
  ...
  return (
    <>
      ...
      {/* موبائل مینو اوورلے اور drawer کو nav کے باہر render کریں تاکہ پوری screen blur ہو */}
      {isMenuOpen && (
        <>
          {/* overlay: پوری اسکرین پر */}
          <div
            className="fixed inset-0 z-[999] bg-white/40 backdrop-blur-lg backdrop-saturate-150 transition-all"
