...
export default function Navigation() {
  ...
  return (
    <nav className="backdrop-blur-lg bg-white/70 shadow-lg fixed w-full z-50 border-b-0 h-14 sm:h-16 flex items-center">
      ...
      {/* موبائل مینو */}
      {isMenuOpen && (
  // classic موبائل drawer: left پر sidebar, overlay پوری screen پر
  <div className="fixed inset-0 z-[999]">
    ...
    <div className="absolute left-0 top-0 h-full w-4/5 max-w-xs bg-white shadow-lg p-6 flex flex-col gap-2 animate-slideInLeft">
      {/* Close button */}
      <button
      ...
      <Link href="/ev-parts" className="block text-gray-700 hover:text-primary text-base font-semibold py-2 px-2 rounded transition" onClick={() => setIsMenuOpen(false)}>EV Parts</Link>
      <Link href="/ev-kits" className="block text-gray-700 hover:text-primary text-base font-semibold py-2 px-2 rounded transition" onClick={() => setIsMenuOpen(false)}>EV Kits</Link>
      <Link href="/solar-parts" className="block text-gray-700 hover:text-primary text-base font-semibold py-2 px-2 rounded transition" onClick={() => setIsMenuOpen(false)}>Solar Parts</Link>
      <Link href="/ev-batteries" className="block text-gray-700 hover:text-primary text-base font-semibold py-2 px-2 rounded transition" onClick={() => setIsMenuOpen(false)}>EV Batteries</Link>
      <Link href="/solar-batteries" className="block text-gray-700 hover:text-primary text-base font-semibold py-2 px-2 rounded transition" onClick={() => setIsMenuOpen(false)}>Solar Batteries</Link>
