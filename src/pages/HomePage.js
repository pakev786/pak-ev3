            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-16">
              ...
              <div className="space-y-6">
                ...
                <p className="text-gray-500 text-sm leading-relaxed max-w-xs">
                  We are a proud Pakistani brand dedicated to converting fuel vehicles to electric, providing high-quality EV components nationwide at the most competitive rates.
                </p>
              </div>
